...
public:
    ...
    using SliderHandler = void (*)(const char* componentId, const char* actionId, int value, void* context);

    bool initialize(uint8_t brightnessPercent);
    bool isReady() const;
    void setButtonHandler(ButtonHandler handler, void* context);
    void setSliderHandler(SliderHandler handler, void* context);
